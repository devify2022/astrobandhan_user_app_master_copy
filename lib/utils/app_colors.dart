...
const kTextColor = Color(0xFF2D2D6C);
...
const gradientColors = [
  Color.fromRGBO(60, 0, 255, 0.31),
  Color.fromRGBO(170, 255, 0, 0.25),
];
const gradientBorderColors = [
  Color.fromRGBO(60, 0, 255, 0.3),
  Color.fromRGBO(170, 255, 0, 0.2),
];

//
const MaterialColor primarySwatch = MaterialColor(0xFF00adbb, <int, Color>{
  50: Color(0xFF00adbb),
  100: Color(0xFF00adbb),
  200: Color(0xFF00adbb),
  300: Color(0xFF00adbb),
  400: Color(0xFF00adbb),
  500: Color(0xFF00adbb),
  600: Color(0xFF00adbb),
  700: Color(0xFF00adbb),
  800: Color(0xFF00adbb),
  900: Color(0xFF00adbb),
});

const Color kPrimaryColor = Color(0xFF1a237e);
const Color scaffoldBackgroundColor = Color(0xFF0F0F55);
const Color scaffoldBackgroundColor2 = Color(0xFF000069);
...
const Color greenColor = Color(0xFF4f9b97);
...
const Color newOrangeColor = Color(0xFFd25027);
...
const Color darkBlueColor = Color(0xFF103258);
const Color lightblueColor = Color(0xFFECF5FF);
const Color lightGreyColor = Color(0xFFEFF0FD);
